...
!(function (e, t) {
  if ("object" == typeof exports && "object" == typeof module) module.exports = t(require("mapboxgl"));
  else if ("function" == typeof define && define.amd) define(["mapboxgl"], t);
  else {
    var o = "object" == typeof exports ? t(require("mapboxgl")) : t(e.mapboxgl);
  ...
  (() => {
    var t = {
        335: (e, t, o) => {
          ...
          var r = {
              ...
              $root: {
                ...
                projection: {
                  ...
                  example: { name: "albers", center: [-154, 50], parallels: [55, 65] },
                },
                layers: {
                  required: !0,
                  type: "array",
              ...
              source_vector: {
                ...
                volatile: {
                  ...
                  "sdk-support": { "basic functionality": { android: "9.3.0", ios: "5.10.0" } },
                },
              ...
              layout_sky: {
                visibility: {
                  ...
                  doc: "Whether this layer is displayed.",
                  "sdk-support": {
                    "basic functionality": { js: "2.0.0", ios: "10.0.0", android: "10.0.0" },
                  },
                  "property-type": "constant",
                },
              },
              ...
              filter_operator: {
                ...
                values: {
                  ...
                  within: { doc: '`["within", object]` feature geometry is within object geometry' },
                },
                ...
                values: {
                  ...
                  format: {
                    ...
                    "sdk-support": {
                      ...
                      image: { js: "1.6.0", android: "8.6.0", ios: "5.7.0", macos: "0.15.0" },
                    },
                  },
                  image: {
                  ...
                  distance: {
                    ...
                    group: "Math",
                    "sdk-support": {
                      "basic functionality": { android: "9.2.0", ios: "5.9.0", macos: "0.16.0" },
                    },
                  },
                  "==": {
                  ...
                  "is-supported-script": {
                    ...
                    group: "String",
                    "sdk-support": { "basic functionality": { js: "0.45.0", android: "6.6.0" } },
                  },
                  upcase: {
              ...
              fog: {
                range: {
                  ...
                  example: [0.5, 10],
                  "sdk-support": {
                    "basic functionality": { js: "2.3.0", android: "10.6.0", ios: "10.6.0" },
                  },
                },
                color: {
                  type: "color",
                ...
                "high-color": {
                  ...
                  "sdk-support": {
                    "basic functionality": { js: "2.9.0", android: "10.6.0", ios: "10.6.0" },
                  },
                },
                "space-color": {
                  type: "color",
              ...
              paint_line: {
                ...
                "line-trim-offset": {
                  ...
                  maximum: [1, 1],
                  transition: !1,
                  requires: [{ source: "geojson", has: { lineMetrics: !0 } }],
                  "sdk-support": {
                    "basic functionality": {
                      js: "2.9.0",
                      android: "10.5.0",
          ...
          var a = n(function (e, t) {
              !(function (o) {
                var r = t && !t.nodeType && t,
                  n = e && !e.nodeType && e,
                  a = "object" == typeof i && i;
                (a.global !== a && a.window !== a && a.self !== a) || (o = a);
                var s,
                  l,
                  u = 2147483647,
                  c = 36,
                ...
                function v(e, t) {
                  var o = e.split("@"),
                    r = "";
                  return (
                    o.length > 1 && ((r = o[0] + "@"), (e = o[1])),
                    r + b((e = e.replace(h, ".")).split("."), t).join(".")
                  );
                }
                function x(e) {
                  for (var t, o, r = [], i = 0, n = e.length; i < n; )
                    (t = e.charCodeAt(i++)) >= 55296 && t <= 56319 && i < n
                      ? 56320 == (64512 & (o = e.charCodeAt(i++)))
                        ? r.push(((1023 & t) << 10) + (1023 & o) + 65536)
                        : (r.push(t), i--)
                      : r.push(t);
                  return r;
                }
                function w(e) {
                  return b(e, function (e) {
                    var t = "";
                    return (
                      e > 65535 && ((t += y((((e -= 65536) >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
                      t + y(e)
                    );
                  }).join("");
                }
                ...
                function j(e, t, o) {
                  var r = 0;
                  for (e = o ? m(e / 700) : e >> 1, e += m(e / t); e > 455; r += c) e = m(e / 35);
                ...
                function T(e) {
                  var t,
                    ...
                    v = 128,
                    x = 72;
                  for ((o = e.lastIndexOf("-")) < 0 && (o = 0), r = 0; r < o; ++r)
                    ...
                    for (
                      ...
                      i >= y && g("invalid-input"),
                        ((l =
                          ...
                          g("overflow"),
                        (b += l * a),
                        !(l < (p = s <= x ? 1 : s >= x + 26 ? 26 : s - x));
                      s += c
                    )
                      a > m(u / (d = c - p)) && g("overflow"), (a *= d);
                    (x = j(b - n, (t = f.length + 1), 0 == n)),
                      m(b / t) > u - v && g("overflow"),
                      (v += m(b / t)),
                      (b %= t),
                      f.splice(b++, 0, v);
                  }
                ...
                function z(e) {
                  var t,
                    ...
                    w,
                    T = [];
                  for (f = (e = x(e)).length, t = 128, o = 0, n = 72, a = 0; a < f; ++a)
                    (h = e[a]) < 128 && T.push(y(h));
                  for (r = i = T.length, i && T.push("-"); r < f; ) {
                    for (s = u, a = 0; a < f; ++a) (h = e[a]) >= t && h < s && (s = h);
                    for (s - t > m((u - o) / (b = r + 1)) && g("overflow"), o += (s - t) * b, t = s, a = 0; a < f; ++a)
                      if (((h = e[a]) < t && ++o > u && g("overflow"), h == t)) {
                        for (l = o, p = c; !(l < (d = p <= n ? 1 : p >= n + 26 ? 26 : p - n)); p += c)
                          (w = l - d), (v = c - d), T.push(y(k(d + (w % v), 0))), (l = m(w / v));
                        T.push(y(k(l, 0))), (n = j(o, b, r == i)), (o = 0), ++r;
                      }
                    ++o, ++t;
                  }
                  return T.join("");
                ...
                if (
                  ...
                  if (e.exports == r) n.exports = s;
                  else for (l in s) s.hasOwnProperty(l) && (r[l] = s[l]);
                else o.punycode = s;
              })(i);
            }),
            s = function (e) {
          ...
          var p = function (e, t, o, r) {
              ...
              for (var l = 0; l < s; ++l) {
                var u,
                  ...
                  f = e[l].replace(n, "%20"),
                  m = f.indexOf(o);
                m >= 0 ? ((u = f.substr(0, m)), (p = f.substr(m + 1))) : ((u = f), (p = "")),
                  (d = decodeURIComponent(u)),
                  (h = decodeURIComponent(p)),
                  c(i, d) ? (Array.isArray(i[d]) ? i[d].push(h) : (i[d] = [i[d], h])) : (i[d] = h);
              }
              return i;
            },
            d = function (e) {
            ...
            h = function (e, t, o, r) {
              return (
                ...
                "object" == typeof e
                  ? Object.keys(e)
                      .map(function (r) {
                        var i = encodeURIComponent(d(r)) + o;
                        return Array.isArray(e[r])
                          ? e[r]
                              .map(function (e) {
                                return i + encodeURIComponent(d(e));
                              })
                              .join(t)
                          : i + encodeURIComponent(d(e[r]));
                      })
                      .join(t)
                  : r
                    ? encodeURIComponent(d(r)) + o + encodeURIComponent(d(e))
                    : ""
              );
            },
            f = n(function (e, t) {
              (t.decode = t.parse = p), (t.encode = t.stringify = h);
            });
          function m() {
            (this.protocol = null),
              (this.slashes = null),
          ...
          function C(e, ...t) {
            for (const o of t) for (const t in o) e[t] = o[t];
            return e;
          }
          (m.prototype.parse = function (e, t, o) {
            ...
            n[0] = n[0].replace(/\\/g, "/");
            var l = (e = n.join(i));
            if (((l = l.trim()), !o && 1 === e.split("#").length)) {
              var u = b.exec(l);
              if (u)
                return (
                  (this.path = l),
                  ...
                  (this.pathname = u[1]),
                  u[2]
                    ? ((this.search = u[2]), (this.query = t ? f.parse(this.search.substr(1)) : this.search.substr(1)))
            ...
            if (c) {
              ...
              (this.protocol = p), (l = l.substr(c.length));
            }
            if (o || c || l.match(/^\/\/[^@\/]+@[^@\/]+/)) {
              var d = "//" === l.substr(0, 2);
              !d || (c && _[c]) || ((l = l.substr(2)), (this.slashes = !0));
            }
            if (!_[c] && (d || (c && !A[c]))) {
              for (var h, m, g = -1, v = 0; v < k.length; v++)
                -1 !== (C = l.indexOf(k[v])) && (-1 === g || C < g) && (g = C);
              for (
                -1 !== (m = -1 === g ? l.lastIndexOf("@") : l.lastIndexOf("@", g)) &&
                  ((h = l.slice(0, m)), (l = l.slice(m + 1)), (this.auth = decodeURIComponent(h))),
                  g = -1,
                  v = 0;
                v < w.length;
                v++
                ...
                var C;
                -1 !== (C = l.indexOf(w[v])) && (-1 === g || C < g) && (g = C);
              }
              -1 === g && (g = l.length),
                (this.host = l.slice(0, g)),
                (l = l.slice(g)),
                this.parseHost(),
                (this.hostname = this.hostname || "");
              var E = "[" === this.hostname[0] && "]" === this.hostname[this.hostname.length - 1];
              if (!E)
                for (var S = this.hostname.split(/\./), O = ((v = 0), S.length); v < O; v++) {
                  var R = S[v];
                  if (R && !R.match(j)) {
                    for (var I = "", q = 0, N = R.length; q < N; q++) R.charCodeAt(q) > 127 ? (I += "x") : (I += R[q]);
                    if (!I.match(j)) {
                      var D = S.slice(0, v),
                        L = S.slice(v + 1),
                        M = R.match(T);
                      M && (D.push(M[1]), L.unshift(M[2])),
                        L.length && (l = "/" + L.join(".") + l),
              ...
              this.hostname.length > 255 ? (this.hostname = "") : (this.hostname = this.hostname.toLowerCase()),
                E || (this.hostname = a.toASCII(this.hostname));
              var P = this.port ? ":" + this.port : "",
                F = this.hostname || "";
              (this.host = F + P),
                (this.href += this.host),
                E &&
                  ((this.hostname = this.hostname.substr(1, this.hostname.length - 2)), "/" !== l[0] && (l = "/" + l));
            }
            if (!z[p])
              for (v = 0, O = x.length; v < O; v++) {
                var $ = x[v];
                if (-1 !== l.indexOf($)) {
                  var U = encodeURIComponent($);
                  U === $ && (U = escape($)), (l = l.split($).join(U));
                }
              }
            var B = l.indexOf("#");
            ...
            if (
              (-1 !== J
                ? ((this.search = l.substr(J)),
                  (this.query = l.substr(J + 1)),
                  t && (this.query = f.parse(this.query)),
                  (l = l.slice(0, J)))
                : t && ((this.search = ""), (this.query = {})),
              l && (this.pathname = l),
              A[p] && this.hostname && !this.pathname && (this.pathname = "/"),
            ...
            (m.prototype.format = function () {
              ...
              this.host
                ...
                this.query && l(this.query) && Object.keys(this.query).length && (n = f.stringify(this.query));
              var a = this.search || (n && "?" + n) || "";
              return (
                t && ":" !== t.substr(-1) && (t += ":"),
                this.slashes || ((!t || A[t]) && !1 !== i)
                  ? ((i = "//" + (i || "")), o && "/" !== o.charAt(0) && (o = "/" + o))
                  : i || (i = ""),
                r && "#" !== r.charAt(0) && (r = "#" + r),
                a && "?" !== a.charAt(0) && (a = "?" + a),
                t +
            ...
            (m.prototype.resolve = function (e) {
              return this.resolveObject(
                (function (e, t, o) {
                  if (e && l(e) && e instanceof m) return e;
                  var r = new m();
            ...
            (m.prototype.resolveObject = function (e) {
              ...
              for (var o = new m(), r = Object.keys(this), i = 0; i < r.length; i++) {
                var n = r[i];
                o[n] = this[n];
              }
              ...
              if (e.slashes && !e.protocol) {
                ...
                return (
                  A[o.protocol] && o.hostname && !o.pathname && (o.path = o.pathname = "/"), (o.href = o.format()), o
                );
              }
              if (e.protocol && e.protocol !== o.protocol) {
                ...
                if (((o.protocol = e.protocol), e.host || _[e.protocol])) o.pathname = e.pathname;
                else {
              ...
              var b = o.pathname && "/" === o.pathname.charAt(0),
                v = e.host || (e.pathname && "/" === e.pathname.charAt(0)),
                x = v || b || (o.host && e.pathname),
                w = x,
                k = (o.pathname && o.pathname.split("/")) || [],
                j = ((f = (e.pathname && e.pathname.split("/")) || []), o.protocol && !A[o.protocol]);
              if (
                (j &&
                  ((o.hostname = ""),
                  (o.port = null),
                  o.host && ("" === k[0] ? (k[0] = o.host) : k.unshift(o.host)),
                  (o.host = ""),
                  e.protocol &&
                    ((e.hostname = null),
                    (e.port = null),
                ...
                (o.host = e.host || "" === e.host ? e.host : o.host),
                  (o.hostname = e.hostname || "" === e.hostname ? e.hostname : o.hostname),
                  (o.search = e.search),
                  (o.query = e.query),
                  (k = f);
              else if (f.length) k || (k = []), k.pop(), (k = k.concat(f)), (o.search = e.search), (o.query = e.query);
              else if (null != e.search)
                return (
                  j &&
                    ((o.hostname = o.host = k.shift()),
                    (S = !!(o.host && o.host.indexOf("@") > 0) && o.host.split("@")) &&
                      ((o.auth = S.shift()), (o.host = o.hostname = S.shift()))),
                  (o.search = e.search),
                  (o.query = e.query),
              ...
              if (!k.length)
                return (
                  (o.pathname = null), o.search ? (o.path = "/" + o.search) : (o.path = null), (o.href = o.format()), o
                );
              for (
                var T = k.slice(-1)[0],
                  z = ((o.host || e.host || k.length > 1) && ("." === T || ".." === T)) || "" === T,
                  C = 0,
                  E = k.length;
                E >= 0;
                E--
              )
                "." === (T = k[E]) ? k.splice(E, 1) : ".." === T ? (k.splice(E, 1), C++) : C && (k.splice(E, 1), C--);
              if (!x && !w) for (; C--; C) k.unshift("..");
              !x || "" === k[0] || (k[0] && "/" === k[0].charAt(0)) || k.unshift(""),
                z && "/" !== k.join("/").substr(-1) && k.push("");
              var S,
                O = "" === k[0] || (k[0] && "/" === k[0].charAt(0));
              return (
                j &&
                  ((o.hostname = o.host = O ? "" : k.length ? k.shift() : ""),
                  (S = !!(o.host && o.host.indexOf("@") > 0) && o.host.split("@")) &&
                    ((o.auth = S.shift()), (o.host = o.hostname = S.shift()))),
                (x = x || (o.host && k.length)) && !O && k.unshift(""),
                k.length ? (o.pathname = k.join("/")) : ((o.pathname = null), (o.path = null)),
                (u(o.pathname) && u(o.search)) ||
                  (o.path = (o.pathname ? o.pathname : "") + (o.search ? o.search : "")),
          ...
          class O {
            constructor(e, t = []) {
              ...
              for (const [e, o] of t) this.bindings[e] = o;
            }
            concat(e) {
              return new O(this, e);
            }
          ...
          const I = { kind: "null" },
            ...
            F = { kind: "collator" },
            $ = { kind: "formatted" },
            U = { kind: "resolvedImage" };
          function B(e, t) {
            return { kind: "array", itemType: e, N: t };
          }
          function J(e) {
            if ("array" === e.kind) {
              const t = J(e.itemType);
          ...
          const W = [I, q, N, D, L, $, M, B(P), U];
          function G(e, t) {
            if ("error" === t.kind) return null;
            if ("array" === e.kind) {
              if (
                "array" === t.kind &&
                ((0 === t.N && "value" === t.itemType.kind) || !G(e.itemType, t.itemType)) &&
                ("number" != typeof e.N || e.N === t.N)
              )
                return null;
            } else {
              if (e.kind === t.kind) return null;
              if ("value" === e.kind) for (const e of W) if (!G(e, t)) return null;
            }
            return `Expected ${J(e)} but found ${J(t)} instead.`;
          }
          function H(e, t) {
          ...
          var Z = n(function (e, t) {
            ...
            function s(e, t, o) {
              return (
                o < 0 ? (o += 1) : o > 1 && (o -= 1),
                6 * o < 1 ? e + (t - e) * o * 6 : 2 * o < 1 ? t : 3 * o < 2 ? e + (t - e) * (2 / 3 - o) * 6 : e
              );
            }
            try {
                ...
                if ("#" === i[0])
                  return 4 === i.length
                    ? (t = parseInt(i.substr(1), 16)) >= 0 && t <= 4095
                      ...
                      : null
                    : 7 === i.length && (t = parseInt(i.substr(1), 16)) >= 0 && t <= 16777215
                ...
                if (-1 !== l && u + 1 === i.length) {
                  ...
                  switch (c) {
                    case "rgba":
                      ...
                      d = a(p.pop());
                    case "rgb":
                      return 3 !== p.length ? null : [n(p[0]), n(p[1]), n(p[2]), d];
                    case "hsla":
                      if (4 !== p.length) return null;
                      d = a(p.pop());
                    case "hsl":
                      ...
                      var h = (((parseFloat(p[0]) % 360) + 360) % 360) / 360,
                        f = a(p[1]),
                        m = a(p[2]),
                        y = m <= 0.5 ? m * (f + 1) : m + f - m * f,
                        g = 2 * m - y;
                      return [r(255 * s(g, y, h + 1 / 3)), r(255 * s(g, y, h)), r(255 * s(g, y, h - 1 / 3)), d];
                    default:
                      return null;
                  }
                }
          ...
          class X {
            ...
            static parse(e) {
              ...
              const t = Z.parseCSSColor(e);
              return t ? new X((t[0] / 255) * t[3], (t[1] / 255) * t[3], (t[2] / 255) * t[3], t[3]) : void 0;
            }
            toString() {
              const [e, t, o, r] = this.toArray();
              return `rgba(${Math.round(e)},${Math.round(t)},${Math.round(o)},${r})`;
            }
            toArray() {
              const { r: e, g: t, b: o, a: r } = this;
              return 0 === r ? [0, 0, 0, 0] : [(255 * e) / r, (255 * t) / r, (255 * o) / r, r];
            }
            toArray01() {
              const { r: e, g: t, b: o, a: r } = this;
              return 0 === r ? [0, 0, 0, 0] : [e / r, t / r, o / r, r];
            }
          ...
          class ee {
            ...
            static fromString(e) {
              return new ee([new Q(e, null, null, null, null)]);
            }
            isEmpty() {
              return (
                0 === this.sections.length ||
                !this.sections.some((e) => 0 !== e.text.length || (e.image && 0 !== e.image.name.length))
              );
            }
            static factory(e) {
            ...
            serialize() {
              ...
              for (const t of this.sections) {
                ...
                e.push(t.text);
                const o = {};
                t.fontStack && (o["text-font"] = ["literal", t.fontStack.split(",")]),
                  t.scale && (o["font-scale"] = t.scale),
                  t.textColor && (o["text-color"] = ["rgba"].concat(t.textColor.toArray())),
                  e.push(o);
              }
              return e;
            }
          ...
          class te {
            ...
            static fromString(e) {
              return e ? new te({ name: e, available: !1 }) : null;
            }
            serialize() {
          ...
          function oe(e, t, o, r) {
            return "number" == typeof e &&
              ...
              ? void 0 === r || ("number" == typeof r && r >= 0 && r <= 1)
                ? null
                : `Invalid rgba value [${[e, t, o, r].join(", ")}]: 'a' must be between 0 and 1.`
              : `Invalid rgba value [${("number" == typeof r ? [e, t, o, r] : [e, t, o]).join(", ")}]: 'r', 'g', and 'b' must be between 0 and 255.`;
          }
          function re(e) {
            if (null === e) return !0;
          ...
          function ie(e) {
            ...
            if ("boolean" == typeof e) return D;
            if ("number" == typeof e) return q;
            if (e instanceof Y) return L;
            if (e instanceof K) return F;
            if (e instanceof ee) return $;
            if (e instanceof te) return U;
            if (Array.isArray(e)) {
              const t = e.length;
              let o;
              for (const t of e) {
          ...
          function ne(e) {
            ...
            return null === e
              ...
              : "string" === t || "number" === t || "boolean" === t
                ? String(e)
                : e instanceof Y || e instanceof ee || e instanceof te
                  ? e.toString()
                  : JSON.stringify(e);
          }
          class ae {
          ...
          const ue = { string: N, number: q, boolean: D, object: M };
          class ce {
            constructor(e, t) {
            ...
            static parse(e, t) {
              ...
              if ("array" === i) {
                ...
                if (e.length > 2) {
                  const o = e[1];
                  if ("string" != typeof o || !(o in ue) || "object" === o)
            ...
            evaluate(e) {
              for (let t = 0; t < this.args.length; t++) {
                const o = this.args[t].evaluate(e);
                if (!G(this.type, ie(o))) return o;
                if (t === this.args.length - 1)
                  throw new le(`Expected value to be of type ${J(this.type)}, but found ${J(ie(o))} instead.`);
              }
              return null;
            }
            eachChild(e) {
          ...
          class de {
            ...
            static parse(e, t) {
              ...
              for (let o = 1; o <= e.length - 1; ++o) {
                ...
                if (i && "object" == typeof n && !Array.isArray(n)) {
                  i = !1;
                  let e = null;
                  if (n["font-scale"] && ((e = t.parse(n["font-scale"], 1, q)), !e)) return null;
                  let o = null;
                  if (n["text-font"] && ((o = t.parse(n["text-font"], 1, B(N))), !o)) return null;
                  let a = null;
                  if (n["text-color"] && ((a = t.parse(n["text-color"], 1, L)), !a)) return null;
                  const s = r[r.length - 1];
                  (s.scale = e), (s.font = o), (s.textColor = a);
                } else {
                  const n = t.parse(e[o], 1, P);
                  if (!n) return null;
                  const a = n.type.kind;
                  if ("string" !== a && "value" !== a && "null" !== a && "resolvedImage" !== a)
                    return t.error("Formatted text type must be 'string', 'value', 'image' or 'null'.");
                  (i = !0), r.push({ content: n, scale: null, font: null, textColor: null });
                }
              }
              return new de(r);
            }
            evaluate(e) {
              return new ee(
                this.sections.map((t) => {
                  const o = t.content.evaluate(e);
                  return ie(o) === U
                    ? new Q("", o, null, null, null)
                    : new Q(
                        ne(o),
                        null,
            ...
            serialize() {
              ...
              for (const t of this.sections) {
                ...
                const o = {};
                t.scale && (o["font-scale"] = t.scale.serialize()),
                  t.font && (o["text-font"] = t.font.serialize()),
                  t.textColor && (o["text-color"] = t.textColor.serialize()),
                  e.push(o);
              }
              return e;
            }
          ...
          class he {
            constructor(e) {
              (this.type = U), (this.input = e);
            }
            static parse(e, t) {
              if (2 !== e.length) return t.error("Expected two arguments.");
              const o = t.parse(e[1], 1, N);
              return o ? new he(o) : t.error("No image name provided.");
            }
            evaluate(e) {
              const t = this.input.evaluate(e),
                o = te.fromString(t);
              return o && e.availableImages && (o.available = e.availableImages.indexOf(t) > -1), o;
            }
            eachChild(e) {
              e(this.input);
            }
          ...
          const fe = { "to-boolean": D, "to-color": L, "to-number": q, "to-string": N };
          class me {
            constructor(e, t) {
              (this.type = e), (this.args = t);
            }
            ...
            evaluate(e) {
              ...
              if ("color" === this.type.kind) {
                ...
                for (const r of this.args) {
                  if (((t = r.evaluate(e)), (o = null), t instanceof Y)) return t;
                  if ("string" == typeof t) {
                    ...
                    ((o =
                      t.length < 3 || t.length > 4
                        ? `Invalid rbga value ${JSON.stringify(t)}: expected an array containing either three or four numeric values.`
                        : oe(t[0], t[1], t[2], t[3])),
                    !o)
                  )
                    return new Y(t[0] / 255, t[1] / 255, t[2] / 255, t[3]);
                }
                throw new le(
                  o || `Could not parse color from value '${"string" == typeof t ? t : String(JSON.stringify(t))}'`
                );
              }
              if ("number" === this.type.kind) {
                let t = null;
                for (const o of this.args) {
                  if (((t = o.evaluate(e)), null === t)) return 0;
                  const r = Number(t);
                  if (!isNaN(r)) return r;
                }
                throw new le(`Could not convert ${JSON.stringify(t)} to number.`);
              }
              return "formatted" === this.type.kind
                ? ee.fromString(ne(this.args[0].evaluate(e)))
                : "resolvedImage" === this.type.kind
                  ? te.fromString(ne(this.args[0].evaluate(e)))
                  : ne(this.args[0].evaluate(e));
            }
            eachChild(e) {
              this.args.forEach(e);
            }
            ...
            serialize() {
              if ("formatted" === this.type.kind)
                return new de([{ content: this.args[0], scale: null, font: null, textColor: null }]).serialize();
          ...
          var ye = me;
          const ge = ["Unknown", "Point", "LineString", "Polygon"];
          var be = class {
            constructor() {
              (this.globals = null),
                (this.feature = null),
            ...
            distanceFromCenter() {
              if (this.featureTileCoord && this.featureDistanceData) {
                const e = this.featureDistanceData.center,
                  ...
                  { x: o, y: r } = this.featureTileCoord,
                  i = o * t - e[0],
                  n = r * t - e[1];
                return this.featureDistanceData.bearing[0] * i + this.featureDistanceData.bearing[1] * n;
              }
              return 0;
            }
            parseColor(e) {
              let t = this._parseColorCache[e];
              return t || (t = this._parseColorCache[e] = Y.parse(e)), t;
            }
          };
          class ve {
            constructor(e, t, o, r) {
            ...
            static parse(e, t) {
              const o = e[0],
                r = ve.definitions[o];
              if (!r)
                return t.error(`Unknown expression "${o}". If you wanted a literal array, use ["literal", [...]].`, 0);
              const i = Array.isArray(r) ? r[0] : r.type,
                n = Array.isArray(r) ? [[r[1], r[2]]] : r.overloads,
                a = n.filter(([t]) => !Array.isArray(t) || t.length === e.length - 1);
              let s = null;
              for (const [r, n] of a) {
                s = new He(t.registry, t.path, null, t.scope);
                const a = [];
                let l = !1;
                for (let t = 1; t < e.length; t++) {
                  const o = e[t],
                    i = Array.isArray(r) ? r[t - 1] : r.type,
                    n = s.parse(o, 1 + a.length, i);
                  if (!n) {
                    l = !0;
                    break;
                  }
                ...
                if (!l)
                  if (Array.isArray(r) && r.length !== a.length)
                    s.error(`Expected ${r.length} arguments, but found ${a.length} instead.`);
                  else {
                    for (let e = 0; e < a.length; e++) {
                      const t = Array.isArray(r) ? r[e] : r.type,
                        o = a[e];
                      s.concat(e + 1).checkSubtype(t, o.type);
                    }
                    if (0 === s.errors.length) return new ve(o, i, n, a);
                  }
              }
              if (1 === a.length) t.errors.push(...s.errors);
              else {
                const o = (a.length ? a : n)
                    .map(([e]) => {
                      return (t = e), Array.isArray(t) ? `(${t.map(J).join(", ")})` : `(${J(t.type)}...)`;
                      var t;
                    })
                    .join(" | "),
                  r = [];
                for (let o = 1; o < e.length; o++) {
                  const i = t.parse(e[o], 1 + r.length);
                  if (!i) return null;
                  r.push(J(i.type));
                }
                t.error(`Expected arguments of type ${o}, but found (${r.join(", ")}) instead.`);
              }
              return null;
            }
            static register(e, t) {
              ve.definitions = t;
              for (const o in t) e[o] = ve;
            }
          }
          var xe = ve;
          class we {
            constructor(e, t, o) {
              (this.type = F), (this.locale = o), (this.caseSensitive = e), (this.diacriticSensitive = t);
            }
            static parse(e, t) {
              ...
              const r = t.parse(void 0 !== o["case-sensitive"] && o["case-sensitive"], 1, D);
              if (!r) return null;
              const i = t.parse(void 0 !== o["diacritic-sensitive"] && o["diacritic-sensitive"], 1, D);
              if (!i) return null;
              let n = null;
              return o.locale && ((n = t.parse(o.locale, 1, N)), !n) ? null : new we(r, i, n);
            }
            evaluate(e) {
              return new K(
          ...
          function ze(e, t) {
            const o = (180 + e[0]) / 360,
              r = ((i = e[1]), (180 - (180 / Math.PI) * Math.log(Math.tan(Math.PI / 4 + (i * Math.PI) / 360))) / 360);
            var i;
            const n = Math.pow(2, t.z);
            return [Math.round(o * n * ke), Math.round(r * n * ke)];
          }
          function _e(e, t, o) {
            const r = e[0] - t[0],
              i = e[1] - t[1],
          ...
          function Ae(e, t) {
            ...
            for (let a = 0, s = t.length; a < s; a++) {
              ...
              for (let t = 0, a = s.length; t < a - 1; t++) {
                if (_e(e, s[t], s[t + 1])) return !1;
                (r = e),
                  (i = s[t]),
                  (n = s[t + 1]),
                  i[1] > r[1] != n[1] > r[1] &&
                    r[0] < ((n[0] - i[0]) * (r[1] - i[1])) / (n[1] - i[1]) + i[0] &&
                    (o = !o);
              }
            }
            var r, i, n;
          ...
          function Ce(e, t) {
            for (let o = 0; o < t.length; o++) if (Ae(e, t[o])) return !0;
            return !1;
          }
          function Ee(e, t, o, r) {
            const i = e[0] - o[0],
          ...
          function Se(e, t, o, r) {
            ...
            return (
              0 != (n = [r[0] - o[0], r[1] - o[1]])[0] * (a = i)[1] - n[1] * a[0] &&
              !(!Ee(e, t, o, r) || !Ee(o, r, e, t))
            );
            var n, a;
          }
          function Oe(e, t, o) {
            for (const r of o) for (let o = 0; o < r.length - 1; ++o) if (Se(e, t, r[o], r[o + 1])) return !0;
            return !1;
          }
          function Re(e, t) {
            for (let o = 0; o < e.length; ++o) if (!Ae(e[o], t)) return !1;
            for (let o = 0; o < e.length - 1; ++o) if (Oe(e[o], e[o + 1], t)) return !1;
            return !0;
          }
          function Ie(e, t) {
            for (let o = 0; o < t.length; o++) if (Re(e, t[o])) return !0;
            return !1;
          }
          function qe(e, t, o) {
            const r = [];
          ...
          function De(e, t, o, r) {
            if (e[0] < o[0] || e[0] > o[2]) {
              const t = 0.5 * r;
              let i = e[0] - o[0] > t ? -r : o[0] - e[0] > t ? r : 0;
              0 === i && (i = e[0] - o[2] > t ? -r : o[2] - e[0] > t ? r : 0), (e[0] += i);
            }
            je(t, e);
          }
          function Le(e, t, o, r) {
            const i = Math.pow(2, r.z) * ke,
              n = [r.x * ke, r.y * ke],
              a = [];
            if (!e) return a;
            for (const r of e)
              for (const e of r) {
                const r = [e.x + n[0], e.y + n[1]];
                De(r, t, o, i), a.push(r);
              }
            return a;
          }
          function Me(e, t, o, r) {
            ...
            if (t[2] - t[0] <= i / 2) {
              ...
              for (const e of a) for (const r of e) De(r, t, o, i);
            }
            var s;
            return a;
          }
          class Pe {
            constructor(e, t) {
              (this.type = D), (this.geojson = e), (this.geometries = t);
            }
            static parse(e, t) {
              if (2 !== e.length)
              ...
              if (re(e[1])) {
                ...
                if ("FeatureCollection" === t.type)
                  for (let e = 0; e < t.features.length; ++e) {
                    const o = t.features[e].geometry.type;
                    if ("Polygon" === o || "MultiPolygon" === o) return new Pe(t, t.features[e].geometry);
                  }
                else if ("Feature" === t.type) {
                  const e = t.geometry.type;
                  if ("Polygon" === e || "MultiPolygon" === e) return new Pe(t, t.geometry);
                } else if ("Polygon" === t.type || "MultiPolygon" === t.type) return new Pe(t, t);
              }
              ...
              if (null != e.geometry() && null != e.canonicalID()) {
                if ("Point" === e.geometryType())
                  return (function (e, t) {
                    ...
                    if (!i) return !1;
                    if ("Polygon" === t.type) {
                      const n = qe(t.coordinates, r, i),
                        a = Le(e.geometry(), o, r, i);
                      if (!Te(o, r)) return !1;
                      for (const e of a) if (!Ae(e, n)) return !1;
                    }
                    if ("MultiPolygon" === t.type) {
                      const n = Ne(t.coordinates, r, i),
                        a = Le(e.geometry(), o, r, i);
                      if (!Te(o, r)) return !1;
                      for (const e of a) if (!Ce(e, n)) return !1;
                    }
                    return !0;
                  })(e, this.geometries);
                if ("LineString" === e.geometryType())
                  return (function (e, t) {
                    ...
                    if ("Polygon" === t.type) {
                      const n = qe(t.coordinates, r, i),
                        a = Me(e.geometry(), o, r, i);
                      if (!Te(o, r)) return !1;
                      for (const e of a) if (!Re(e, n)) return !1;
                    }
                    if ("MultiPolygon" === t.type) {
                      const n = Ne(t.coordinates, r, i),
                        a = Me(e.geometry(), o, r, i);
                      if (!Te(o, r)) return !1;
                      for (const e of a) if (!Ie(e, n)) return !1;
                    }
                    return !0;
                  })(e, this.geometries);
              }
          ...
          function Ue(e) {
            if (e instanceof xe && "feature-state" === e.name) return !1;
            let t = !0;
            return (
              e.eachChild((e) => {
                t && !Ue(e) && (t = !1);
          ...
          function Be(e, t) {
            if (e instanceof xe && t.indexOf(e.name) >= 0) return !1;
            let o = !0;
            return (
              e.eachChild((e) => {
                o && !Be(e, t) && (o = !1);
          ...
          class Je {
            ...
            static parse(e, t) {
              ...
              const o = e[1];
              return t.scope.has(o)
                ? new Je(o, t.scope.get(o))
                : t.error(
          ...
          class Ge {
            ...
            parse(e, t, o, r, i = {}) {
              return t ? this.concat(t, o, r)._parse(e, i) : this._parse(e, i);
            }
            _parse(e, t) {
              function o(e, t, o) {
                return "assert" === o ? new pe(t, [e]) : "coerce" === o ? new ye(t, [e]) : e;
              }
              if (
                ...
                if (i) {
                  ...
                  if (this.expectedType) {
                    ...
                    if (
                      ...
                      if (
                        ("color" !== e.kind && "formatted" !== e.kind && "resolvedImage" !== e.kind) ||
                        ("value" !== i.kind && "string" !== i.kind)
                      ) {
                        if (this.checkSubtype(e, i)) return null;
                      } else r = o(r, e, t.typeAnnotation || "coerce");
                    else r = o(r, e, t.typeAnnotation || "assert");
                  }
                  if (!(r instanceof se) && "resolvedImage" !== r.type.kind && Ve(r)) {
                    const e = new be();
                    try {
                      r = new se(r.type, r.evaluate(e));
                    } catch (e) {
            ...
            concat(e, t, o) {
              ...
              return new Ge(this.registry, r, t || null, i, this.errors);
            }
            error(e, ...t) {
              const o = `${this.key}${t.map((e) => `[${e}]`).join("")}`;
              this.errors.push(new S(o, e));
            }
            checkSubtype(e, t) {
              const o = G(e, t);
          ...
          var He = Ge;
          function Ve(e) {
            if (e instanceof We) return Ve(e.boundExpression);
            if (e instanceof xe && "error" === e.name) return !1;
            if (e instanceof we) return !1;
            if (e instanceof Fe) return !1;
            const t = e instanceof ye || e instanceof pe;
            let o = !0;
            return (
              e.eachChild((e) => {
                o = t ? o && Ve(e) : o && e instanceof se;
              }),
              !!o &&
                $e(e) &&
                Be(e, [
          ...
          function Ze(e, t) {
            ...
            let r,
              ...
              s = 0;
            for (; n <= a; )
              if (((s = Math.floor((n + a) / 2)), (r = e[s]), (i = e[s + 1]), r <= t)) {
                if (s === o || t < i) return s;
                n = s + 1;
              } else {
                if (!(r > t)) throw new le("Input is not a number.");
                a = s - 1;
              }
            return 0;
          }
          class Xe {
            constructor(e, t, o) {
              ...
              for (const [e, t] of o) this.labels.push(e), this.outputs.push(t);
            }
            static parse(e, t) {
              ...
              for (let o = 1; o < e.length; o += 2) {
                ...
                const u = t.parse(a, l, i);
                if (!u) return null;
                (i = i || u.type), r.push([n, u]);
              }
              return new Xe(i, o, r);
            }
            evaluate(e) {
              ...
              const i = t.length;
              return r >= t[i - 1] ? o[i - 1].evaluate(e) : o[Ze(t, r)].evaluate(e);
            }
            eachChild(e) {
              e(this.input);
          ...
          (Qe.prototype.sampleCurveX = function (e) {
            return ((this.ax * e + this.bx) * e + this.cx) * e;
          }),
            (Qe.prototype.sampleCurveY = function (e) {
              return ((this.ay * e + this.by) * e + this.cy) * e;
            }),
            (Qe.prototype.sampleCurveDerivativeX = function (e) {
              return (3 * this.ax * e + 2 * this.bx) * e + this.cx;
            }),
            (Qe.prototype.solveCurveX = function (e, t) {
              var o, r, i, n, a;
              ...
              for (; o < r; ) {
                ...
                e > n ? (o = i) : (r = i), (i = 0.5 * (r - o) + o);
              }
              return i;
            }),
            (Qe.prototype.solve = function (e, t) {
          ...
          var tt = Object.freeze({
            ...
            color: function (e, t, o) {
              return new Y(et(e.r, t.r, o), et(e.g, t.g, o), et(e.b, t.b, o), et(e.a, t.a, o));
            },
            array: function (e, t, o) {
              return e.map((e, r) => et(e, t[r], o));
            },
          });
          const ot = 0.95047,
            rt = 1.08883,
            ...
            lt = 180 / Math.PI;
          function ut(e) {
            return e > 0.008856451679035631 ? Math.pow(e, 1 / 3) : e / at + it;
          }
          function ct(e) {
            return e > nt ? e * e * e : at * (e - it);
          }
          function pt(e) {
          ...
          function ht(e) {
            const t = dt(e.r),
              o = dt(e.g),
              r = dt(e.b),
              i = ut((0.4124564 * t + 0.3575761 * o + 0.1804375 * r) / ot),
              n = ut((0.2126729 * t + 0.7151522 * o + 0.072175 * r) / 1);
            return {
              l: 116 * n - 16,
              a: 500 * (i - n),
              b: 200 * (n - ut((0.0193339 * t + 0.119192 * o + 0.9503041 * r) / rt)),
              alpha: e.a,
            };
          }
          function ft(e) {
            let t = (e.l + 16) / 116,
              o = isNaN(e.a) ? t : t + e.a / 500,
            ...
            return (
              ...
              (r = rt * ct(r)),
              new Y(
                pt(3.2404542 * o - 1.5371385 * t - 0.4985314 * r),
                pt(-0.969266 * o + 1.8760108 * t + 0.041556 * r),
                pt(0.0556434 * o - 0.2040259 * t + 1.0572252 * r),
                e.alpha
              )
            );
          }
          ...
          const yt = {
              ...
              interpolate: function (e, t, o) {
                return {
                  ...
                  a: et(e.a, t.a, o),
                  b: et(e.b, t.b, o),
                  alpha: et(e.alpha, t.alpha, o),
                };
              },
            },
            gt = {
              forward: function (e) {
                const { l: t, a: o, b: r } = ht(e),
                  i = Math.atan2(r, o) * lt;
                return { h: i < 0 ? i + 360 : i, c: Math.sqrt(o * o + r * r), l: t, alpha: e.a };
              },
              reverse: function (e) {
                const t = e.h * st,
                  o = e.c;
                return ft({ l: e.l, a: Math.cos(t) * o, b: Math.sin(t) * o, alpha: e.alpha });
              },
              interpolate: function (e, t, o) {
                return {
                  h: mt(e.h, t.h, o),
          ...
          var bt = Object.freeze({ __proto__: null, lab: yt, hcl: gt });
          class vt {
            constructor(e, t, o, r, i) {
              (this.type = e),
                (this.operator = t),
            ...
            static interpolationFactor(e, t, o, r) {
              let i = 0;
              if ("exponential" === e.name) i = xt(t, e.base, o, r);
              else if ("linear" === e.name) i = xt(t, 1, o, r);
              else if ("cubic-bezier" === e.name) {
                const n = e.controlPoints;
                i = new Ke(n[0], n[1], n[2], n[3]).solve(xt(t, 1, o, r));
              }
              return i;
            }
            static parse(e, t) {
              ...
              if ("linear" === r[0]) r = { name: "linear" };
                ...
                if ("cubic-bezier" !== r[0]) return t.error(`Unknown interpolation type ${String(r[0])}`, 1, 0);
                {
                  ...
                  r = { name: "cubic-bezier", controlPoints: e };
                }
              }
              if (e.length - 1 < 4) return t.error(`Expected at least 4 arguments, but found only ${e.length - 1}.`);
              if ((e.length - 1) % 2 != 0) return t.error("Expected an even number of arguments.");
              if (((i = t.parse(i, 2, q)), !i)) return null;
              const a = [];
              let s = null;
              "interpolate-hcl" === o || "interpolate-lab" === o
                ? (s = L)
                : t.expectedType && "value" !== t.expectedType.kind && (s = t.expectedType);
              for (let e = 0; e < n.length; e += 2) {
                ...
                const u = t.parse(r, l, s);
                if (!u) return null;
                (s = s || u.type), a.push([o, u]);
              }
              return "number" === s.kind ||
                "color" === s.kind ||
                ("array" === s.kind && "number" === s.itemType.kind && "number" == typeof s.N)
                ? new vt(s, o, r, i, a)
                : t.error(`Type ${J(s)} is not interpolatable.`);
            }
            evaluate(e) {
              const t = this.labels,
                o = this.outputs;
              ...
              const n = Ze(t, r),
                a = t[n],
                s = t[n + 1],
                l = vt.interpolationFactor(this.interpolation, r, a, s),
                u = o[n].evaluate(e),
                c = o[n + 1].evaluate(e);
              return "interpolate" === this.operator
                ? tt[this.type.kind.toLowerCase()](u, c, l)
                : "interpolate-hcl" === this.operator
                  ? gt.reverse(gt.interpolate(gt.forward(u), gt.forward(c), l))
                  : yt.reverse(yt.interpolate(yt.forward(u), yt.forward(c), l));
            }
            eachChild(e) {
              e(this.input);
              for (const t of this.outputs) e(t);
          ...
          class kt {
            ...
            static parse(e, t) {
              ...
              for (const r of e.slice(1)) {
                const e = t.parse(r, 1 + i.length, o, void 0, { typeAnnotation: "omit" });
                if (!e) return null;
                (o = o || e.type), i.push(e);
              }
              const n = r && i.some((e) => G(r, e.type));
              return new kt(n ? P : o, i);
            }
            evaluate(e) {
              let t,
                o = null,
              ...
              for (const i of this.args) {
                if (
                  (r++,
                  (o = i.evaluate(e)),
                  o && o instanceof te && !o.available && (t || (t = o), (o = null), r === this.args.length))
                )
                  return t;
                if (null !== o) break;
              }
          ...
          class Tt {
            ...
            static parse(e, t) {
              ...
              for (let r = 1; r < e.length - 1; r += 2) {
                ...
                const n = t.parse(e[r + 1], r + 1);
                if (!n) return null;
                o.push([i, n]);
              }
              const r = t.parse(e[e.length - 1], e.length - 1, t.expectedType, o);
              return r ? new Tt(o, r) : null;
            }
            outputDefined() {
            ...
            serialize() {
              const e = ["let"];
              for (const [t, o] of this.bindings) e.push(t, o.serialize());
          ...
          class _t {
            ...
            static parse(e, t) {
              ...
              const o = t.parse(e[1], 1, q),
                r = t.parse(e[2], 2, B(t.expectedType || P));
              if (!o || !r) return null;
              const i = r.type;
              return new _t(i.itemType, o, r);
            }
            evaluate(e) {
              const t = this.index.evaluate(e),
                o = this.input.evaluate(e);
              if (t < 0) throw new le(`Array index out of bounds: ${t} < 0.`);
              if (t >= o.length) throw new le(`Array index out of bounds: ${t} > ${o.length - 1}.`);
              if (t !== Math.floor(t)) throw new le(`Array index must be an integer, but found ${t} instead.`);
              return o[t];
            }
            eachChild(e) {
          ...
          class Ct {
            constructor(e, t) {
              (this.type = D), (this.needle = e), (this.haystack = t);
            }
            static parse(e, t) {
              if (3 !== e.length) return t.error(`Expected 2 arguments, but found ${e.length - 1} instead.`);
              const o = t.parse(e[1], 1, P),
                r = t.parse(e[2], 2, P);
              return o && r
                ? H(o.type, [D, N, q, I, P])
                  ? new Ct(o, r)
                  : t.error(
                      `Expected first argument to be of type boolean, string, number or null, but found ${J(o.type)} instead`
                    )
                : null;
            }
            evaluate(e) {
              ...
              if (null == o) return !1;
              if (!V(t, ["boolean", "string", "number", "null"]))
                throw new le(
                  `Expected first argument to be of type boolean, string, number or null, but found ${J(ie(t))} instead.`
                );
              if (!V(o, ["string", "array"]))
                throw new le(`Expected second argument to be of type array or string, but found ${J(ie(o))} instead.`);
          ...
          class St {
            constructor(e, t, o) {
              (this.type = q), (this.needle = e), (this.haystack = t), (this.fromIndex = o);
            }
            static parse(e, t) {
              ...
              const o = t.parse(e[1], 1, P),
                r = t.parse(e[2], 2, P);
              if (!o || !r) return null;
              if (!H(o.type, [D, N, q, I, P]))
                return t.error(
                  `Expected first argument to be of type boolean, string, number or null, but found ${J(o.type)} instead`
                );
              if (4 === e.length) {
                const i = t.parse(e[3], 3, q);
                return i ? new St(o, r, i) : null;
              }
              return new St(o, r);
            }
            evaluate(e) {
          ...
          class Rt {
            ...
            static parse(e, t) {
              ...
              for (let a = 2; a < e.length - 1; a += 2) {
                ...
                for (const e of s) {
                  ...
                  if (o) {
                    if (u.checkSubtype(o, ie(e))) return null;
                  } else o = ie(e);
                  if (void 0 !== i[String(e)]) return u.error("Branch labels must be unique.");
                  i[String(e)] = n.length;
                }
                const c = t.parse(l, a, r);
                if (!c) return null;
                (r = r || c.type), n.push(c);
              }
              const a = t.parse(e[1], 1, P);
              if (!a) return null;
              const s = t.parse(e[e.length - 1], e.length - 1, r);
              return s
                ? "value" !== a.type.kind && t.concat(1).checkSubtype(o, a.type)
                  ? null
                  : new Rt(o, r, a, i, n, s)
                : null;
            }
            evaluate(e) {
              const t = this.input.evaluate(e);
              return ((ie(t) === this.inputType && this.outputs[this.cases[t]]) || this.otherwise).evaluate(e);
            }
            eachChild(e) {
            ...
            serialize() {
              ...
              for (const e of t) {
                ...
                void 0 === t ? ((r[this.cases[e]] = o.length), o.push([this.cases[e], [e]])) : o[t][1].push(e);
              }
              const i = (e) => ("number" === this.inputType.kind ? Number(e) : e);
              for (const [t, r] of o)
                1 === r.length ? e.push(i(r[0])) : e.push(r.map(i)), e.push(this.outputs[t].serialize());
          ...
          class qt {
            ...
            static parse(e, t) {
              ...
              for (let i = 1; i < e.length - 1; i += 2) {
                const n = t.parse(e[i], i, D);
                if (!n) return null;
                const a = t.parse(e[i + 1], i + 1, o);
                if (!a) return null;
                r.push([n, a]), (o = o || a.type);
              }
              const i = t.parse(e[e.length - 1], e.length - 1, o);
              return i ? new qt(o, r, i) : null;
            }
            evaluate(e) {
              for (const [t, o] of this.branches) if (t.evaluate(e)) return o.evaluate(e);
              return this.otherwise.evaluate(e);
            }
            eachChild(e) {
              for (const [t, o] of this.branches) e(t), e(o);
              e(this.otherwise);
            }
            outputDefined() {
          ...
          class Dt {
            constructor(e, t, o, r) {
              (this.type = e), (this.input = t), (this.beginIndex = o), (this.endIndex = r);
            }
            static parse(e, t) {
              if (e.length <= 2 || e.length >= 5)
                return t.error(`Expected 3 or 4 arguments, but found ${e.length - 1} instead.`);
              ...
              if (!o || !r) return null;
              if (!H(o.type, [B(P), N, P]))
                return t.error(`Expected first argument to be of type array or string, but found ${J(o.type)} instead`);
              if (4 === e.length) {
                const i = t.parse(e[3], 3, q);
                return i ? new Dt(o.type, o, r, i) : null;
              }
              return new Dt(o.type, o, r);
            }
            evaluate(e) {
              const t = this.input.evaluate(e),
                o = this.beginIndex.evaluate(e);
              if (!V(t, ["string", "array"]))
                throw new le(`Expected first argument to be of type array or string, but found ${J(ie(t))} instead.`);
              if (this.endIndex) {
          ...
          function Ft(e, t, o) {
            ...
            return class i {
              ...
              static parse(e, t) {
                ...
                const o = e[0];
                let n = t.parse(e[1], 1, P);
                if (!n) return null;
                if (!Mt(o, n.type))
                  return t.concat(1).error(`"${o}" comparisons are not supported for type '${J(n.type)}'.`);
                let a = t.parse(e[2], 2, P);
                if (!a) return null;
                if (!Mt(o, a.type))
                  return t.concat(2).error(`"${o}" comparisons are not supported for type '${J(a.type)}'.`);
                if (n.type.kind !== a.type.kind && "value" !== n.type.kind && "value" !== a.type.kind)
                  return t.error(`Cannot compare types '${J(n.type)}' and '${J(a.type)}'.`);
                r &&
                  ("value" === n.type.kind && "value" !== a.type.kind
                    ? (n = new pe(a.type, [n]))
                    : "value" !== n.type.kind && "value" === a.type.kind && (a = new pe(n.type, [a])));
                let s = null;
                if (4 === e.length) {
                  if (
                    "string" !== n.type.kind &&
                  ...
                  if (((s = t.parse(e[3], 3, F)), !s)) return null;
                }
                return new i(n, a, s);
              }
              evaluate(i) {
                const n = this.lhs.evaluate(i),
                  a = this.rhs.evaluate(i);
                if (r && this.hasUntypedArgument) {
                  const t = ie(n),
                    o = ie(a);
                  if (t.kind !== o.kind || ("string" !== t.kind && "number" !== t.kind))
                    throw new le(
                      `Expected arguments for "${e}" to be (string, string) or (number, number), but found (${t.kind}, ${o.kind}) instead.`
                    );
                }
                if (this.collator && !r && this.hasUntypedArgument) {
                  const e = ie(n),
                    o = ie(a);
                  if ("string" !== e.kind || "string" !== o.kind) return t(i, n, a);
                }
          ...
          class Ht {
            ...
            static parse(e, t) {
              ...
              let i = null;
              if (r.locale && ((i = t.parse(r.locale, 1, N)), !i)) return null;
              let n = null;
              if (r.currency && ((n = t.parse(r.currency, 1, N)), !n)) return null;
              let a = null;
              if (r["min-fraction-digits"] && ((a = t.parse(r["min-fraction-digits"], 1, q)), !a)) return null;
              let s = null;
              return r["max-fraction-digits"] && ((s = t.parse(r["max-fraction-digits"], 1, q)), !s)
                ? null
                : new Ht(o, i, n, a, s);
            }
            evaluate(e) {
          ...
          class Vt {
            constructor(e) {
              (this.type = q), (this.input = e);
            }
            static parse(e, t) {
              if (2 !== e.length) return t.error(`Expected 1 argument, but found ${e.length - 1} instead.`);
              const o = t.parse(e[1], 1);
              return o
                ? "array" !== o.type.kind && "string" !== o.type.kind && "value" !== o.type.kind
                  ? t.error(`Expected argument of type string or array, but found ${J(o.type)} instead.`)
                  : new Vt(o)
                : null;
            }
            evaluate(e) {
              ...
              throw new le(`Expected value to be of type string or array, but found ${J(ie(t))} instead.`);
            }
            eachChild(e) {
              e(this.input);
            }
          ...
          function Xt(e, [t, o, r, i]) {
            (t = t.evaluate(e)), (o = o.evaluate(e)), (r = r.evaluate(e));
            const n = i ? i.evaluate(e) : 1,
              a = oe(t, o, r, n);
            if (a) throw new le(a);
            return new Y((t / 255) * n, (o / 255) * n, (r / 255) * n, n);
          }
          function Yt(e, t) {
            return e in t;
          }
          ...
          xe.register(Zt, {
            error: [
              ...
              [N],
              (e, [t]) => {
                throw new le(t.evaluate(e));
              },
            ],
            typeof: [N, [P], (e, [t]) => J(ie(t.evaluate(e)))],
            "to-rgba": [B(q, 4), [L], (e, [t]) => t.evaluate(e).toArray()],
            rgb: [L, [q, q, q], Xt],
            rgba: [L, [q, q, q, q], Xt],
            has: {
              type: D,
              overloads: [
                [[N], (e, [t]) => Yt(t.evaluate(e), e.properties())],
                [[N, M], (e, [t, o]) => Yt(t.evaluate(e), o.evaluate(e))],
              ],
            },
            get: {
              type: P,
              overloads: [
                [[N], (e, [t]) => Kt(t.evaluate(e), e.properties())],
                [[N, M], (e, [t, o]) => Kt(t.evaluate(e), o.evaluate(e))],
              ],
            },
            "feature-state": [P, [N], (e, [t]) => Kt(t.evaluate(e), e.featureState || {})],
            properties: [M, [], (e) => e.properties()],
            "geometry-type": [N, [], (e) => e.geometryType()],
            id: [P, [], (e) => e.id()],
            zoom: [q, [], (e) => e.globals.zoom],
            pitch: [q, [], (e) => e.globals.pitch || 0],
            "distance-from-center": [q, [], (e) => e.distanceFromCenter()],
            "heatmap-density": [q, [], (e) => e.globals.heatmapDensity || 0],
            "line-progress": [q, [], (e) => e.globals.lineProgress || 0],
            "sky-radial-progress": [q, [], (e) => e.globals.skyRadialProgress || 0],
            accumulated: [P, [], (e) => (void 0 === e.globals.accumulated ? null : e.globals.accumulated)],
            "+": [
              q,
              Qt(q),
              (e, t) => {
                let o = 0;
                for (const r of t) o += r.evaluate(e);
                return o;
              },
            ],
            "*": [
            ...
            "-": {
              type: q,
              overloads: [
                [[q, q], (e, [t, o]) => t.evaluate(e) - o.evaluate(e)],
                [[q], (e, [t]) => -t.evaluate(e)],
              ],
            },
            "/": [q, [q, q], (e, [t, o]) => t.evaluate(e) / o.evaluate(e)],
            "%": [q, [q, q], (e, [t, o]) => t.evaluate(e) % o.evaluate(e)],
            ln2: [q, [], () => Math.LN2],
            pi: [q, [], () => Math.PI],
            e: [q, [], () => Math.E],
            "^": [q, [q, q], (e, [t, o]) => Math.pow(t.evaluate(e), o.evaluate(e))],
            sqrt: [q, [q], (e, [t]) => Math.sqrt(t.evaluate(e))],
            log10: [q, [q], (e, [t]) => Math.log(t.evaluate(e)) / Math.LN10],
            ln: [q, [q], (e, [t]) => Math.log(t.evaluate(e))],
            log2: [q, [q], (e, [t]) => Math.log(t.evaluate(e)) / Math.LN2],
            sin: [q, [q], (e, [t]) => Math.sin(t.evaluate(e))],
            cos: [q, [q], (e, [t]) => Math.cos(t.evaluate(e))],
            tan: [q, [q], (e, [t]) => Math.tan(t.evaluate(e))],
            asin: [q, [q], (e, [t]) => Math.asin(t.evaluate(e))],
            acos: [q, [q], (e, [t]) => Math.acos(t.evaluate(e))],
            atan: [q, [q], (e, [t]) => Math.atan(t.evaluate(e))],
            min: [q, Qt(q), (e, t) => Math.min(...t.map((t) => t.evaluate(e)))],
            max: [q, Qt(q), (e, t) => Math.max(...t.map((t) => t.evaluate(e)))],
            abs: [q, [q], (e, [t]) => Math.abs(t.evaluate(e))],
            round: [
              q,
              [q],
              (e, [t]) => {
                const o = t.evaluate(e);
                return o < 0 ? -Math.round(-o) : Math.round(o);
              },
            ],
            floor: [q, [q], (e, [t]) => Math.floor(t.evaluate(e))],
            ceil: [q, [q], (e, [t]) => Math.ceil(t.evaluate(e))],
            "filter-==": [D, [N, P], (e, [t, o]) => e.properties()[t.value] === o.value],
            "filter-id-==": [D, [P], (e, [t]) => e.id() === t.value],
            "filter-type-==": [D, [N], (e, [t]) => e.geometryType() === t.value],
            "filter-<": [
              D,
              [N, P],
              (e, [t, o]) => {
            ...
            "filter-has": [D, [P], (e, [t]) => t.value in e.properties()],
            "filter-has-id": [D, [], (e) => null !== e.id() && void 0 !== e.id()],
            "filter-type-in": [D, [B(N)], (e, [t]) => t.value.indexOf(e.geometryType()) >= 0],
            "filter-id-in": [D, [B(P)], (e, [t]) => t.value.indexOf(e.id()) >= 0],
            "filter-in-small": [D, [N, B(P)], (e, [t, o]) => o.value.indexOf(e.properties()[t.value]) >= 0],
            "filter-in-large": [
              D,
              [N, B(P)],
              (e, [t, o]) =>
                (function (e, t, o, r) {
                  ...
                  return !1;
                })(e.properties()[t.value], o.value, 0, o.value.length - 1),
            ],
            all: {
              type: D,
              overloads: [
                [[D, D], (e, [t, o]) => t.evaluate(e) && o.evaluate(e)],
                [
                  Qt(D),
                  (e, t) => {
                    for (const o of t) if (!o.evaluate(e)) return !1;
                    return !0;
                  },
                ],
              ],
            ...
            any: {
              ...
              overloads: [
                ...
                [
                  Qt(D),
                  (e, t) => {
                    for (const o of t) if (o.evaluate(e)) return !0;
                    return !1;
                  },
                ],
              ],
            },
            "!": [D, [D], (e, [t]) => !t.evaluate(e)],
            "is-supported-script": [
              D,
              [N],
              (e, [t]) => {
                const o = e.globals && e.globals.isSupportedScript;
                return !o || o(t.evaluate(e));
              },
            ],
            upcase: [N, [N], (e, [t]) => t.evaluate(e).toUpperCase()],
            downcase: [N, [N], (e, [t]) => t.evaluate(e).toLowerCase()],
            concat: [N, Qt(P), (e, t) => t.map((t) => ne(t.evaluate(e))).join("")],
            "resolved-locale": [N, [F], (e, [t]) => t.evaluate(e).resolvedLocale()],
          });
          var eo = Zt;
          function to(e) {
          ...
          function so(e, t) {
            const o = "color" === t.type,
              r = e.stops && "object" == typeof e.stops[0][0],
              i = r || void 0 !== e.property,
              n = r || !i,
              a = e.type || (ro(t) ? "exponential" : "interval");
            if (
              (o &&
                ((e = C({}, e)).stops && (e.stops = e.stops.map((e) => [e[0], Y.parse(e[1])])),
                e.default ? (e.default = Y.parse(e.default)) : (e.default = Y.parse(t.default))),
              e.colorSpace && "rgb" !== e.colorSpace && !bt[e.colorSpace])
            )
              throw new Error(`Unknown color space: ${e.colorSpace}`);
            let s, l, u;
            if ("exponential" === a) s = po;
            else if ("interval" === a) s = co;
            else if ("categorical" === a) {
              (s = uo), (l = Object.create(null));
            ...
            if (r) {
              ...
              for (let t = 0; t < e.stops.length; t++) {
                ...
                void 0 === o[n] &&
                  ...
                  r.push(n)),
                  o[n].stops.push([i[0].value, i[1]]);
              }
              const i = [];
              for (const e of r) i.push([o[e].zoom, so(o[e], t)]);
              const n = { name: "linear" };
              return {
                kind: "composite",
                interpolationType: n,
                interpolationFactor: wt.interpolationFactor.bind(void 0, n),
                zoomStops: i.map((e) => e[0]),
                evaluate: ({ zoom: o }, r) => po({ stops: i, base: e.base }, t, o).evaluate(o, r),
              };
            }
            if (n) {
              const o = "exponential" === a ? { name: "exponential", base: void 0 !== e.base ? e.base : 1 } : null;
              return {
                kind: "camera",
                interpolationType: o,
                interpolationFactor: wt.interpolationFactor.bind(void 0, o),
                zoomStops: e.stops.map((e) => e[0]),
                evaluate: ({ zoom: o }) => s(e, t, o, l, u),
              };
            }
            return {
              kind: "source",
              evaluate(o, r) {
                ...
                return void 0 === i ? lo(e.default, t.default) : s(e, t, i, l, u);
              },
            };
          }
          function lo(e, t, o) {
          ...
          function uo(e, t, o, r, i) {
            return lo(typeof o === i ? r[o] : void 0, e.default, t.default);
          }
          function co(e, t, o) {
            if ("number" !== io(o)) return lo(e.default, t.default);
            ...
            const n = Ze(
              ...
              a = (function (e, t, o, r) {
                const i = r - o,
                  n = e - o;
                return 0 === i ? 0 : 1 === t ? n / i : (Math.pow(t, n) - 1) / (Math.pow(t, i) - 1);
              })(o, r, e.stops[n][0], e.stops[n + 1][0]),
              s = e.stops[n][1],
              l = e.stops[n + 1][1];
            let u = tt[t.type] || ao;
            if (e.colorSpace && "rgb" !== e.colorSpace) {
              const t = bt[e.colorSpace];
              u = (e, o) => t.reverse(t.interpolate(t.forward(e), t.forward(o), a));
            }
            return "function" == typeof s.evaluate
              ? {
                  evaluate(...e) {
                    const t = s.evaluate.apply(void 0, e),
                      o = l.evaluate.apply(void 0, e);
                    if (void 0 !== t && void 0 !== o) return u(t, o, a);
                  },
                }
              : u(s, l, a);
          }
          function ho(e, t, o) {
            return (
              "color" === t.type
                ? (o = Y.parse(o))
                : "formatted" === t.type
                  ? (o = ee.fromString(o.toString()))
                  : "resolvedImage" === t.type
                    ? (o = te.fromString(o.toString()))
                    : io(o) === t.type || ("enum" === t.type && t.values[o]) || (o = void 0),
              lo(o, e.default, t.default)
            );
          }
          class fo {
            constructor(e, t) {
              ...
              (this.expression = e),
                ...
                (this._evaluator = new be()),
                (this._defaultValue = t
                  ? "color" === (o = t).type && (no(o.default) || Array.isArray(o.default))
                    ? new Y(0, 0, 0, 0)
                    : "color" === o.type
                      ? Y.parse(o.default) || null
                      : void 0 === o.default
                        ? null
                        : o.default
                  : null),
            ...
            evaluateWithoutErrorHandling(e, t, o, r, i, n, a, s) {
              return (
              ...
              try {
                ...
                return (
                  this._warningHistory[e.message] ||
                    ((this._warningHistory[e.message] = !0), "undefined" != typeof console && console.warn(e.message)),
                  this._defaultValue
                );
              }
            }
          ...
          function mo(e) {
            return Array.isArray(e) && e.length > 0 && "string" == typeof e[0] && e[0] in eo;
          }
          function yo(e, t) {
            const o = new He(
                eo,
                ...
                t
                  ? (function (e) {
                      ...
                      return "array" === e.type ? B(t[e.value] || P, e.length) : t[e.type];
                    })(t)
                  : void 0
              ),
              r = o.parse(e, void 0, void 0, void 0, t && "string" === t.type ? { typeAnnotation: "coerce" } : void 0);
            return r ? to(new fo(r, t)) : oo(o.errors);
          }
          class go {
            constructor(e, t) {
              (this.kind = e),
                (this._styleExpression = t),
                (this.isStateDependent = "constant" !== e && !Ue(t.expression));
            }
            evaluateWithoutErrorHandling(e, t, o, r, i, n) {
              return this._styleExpression.evaluateWithoutErrorHandling(e, t, o, r, i, n);
            }
            evaluate(e, t, o, r, i, n) {
              return this._styleExpression.evaluate(e, t, o, r, i, n);
            }
          }
          class bo {
            constructor(e, t, o, r) {
              (this.kind = e),
                (this.zoomStops = o),
                (this._styleExpression = t),
                (this.isStateDependent = "camera" !== e && !Ue(t.expression)),
            ...
            interpolationFactor(e, t, o) {
              return this.interpolationType ? wt.interpolationFactor(this.interpolationType, e, t, o) : 0;
            }
          }
          function vo(e, t) {
            if ("error" === (e = yo(e, t)).result) return e;
            const o = e.value.expression,
              r = $e(o);
            if (!r && "data-driven" !== (i = t)["property-type"] && "cross-faded-data-driven" !== i["property-type"])
              return oo([new S("", "data expressions not supported")]);
            var i;
            const n = Be(o, ["zoom", "pitch", "distance-from-center"]);
            if (
              !n &&
              !(function (e) {
              ...
              return oo([new S("", "zoom expressions not supported")]);
            const a = wo(o);
            if (!a && !n)
              return oo([
                new S(
            ...
            if (a instanceof S) return oo([a]);
            if (a instanceof wt && !ro(t))
              return oo([new S("", '"interpolate" expressions cannot be used with this property')]);
            if (!a) return to(new go(r ? "constant" : "source", e.value));
            const s = a instanceof wt ? a.interpolation : void 0;
            return to(new bo(r ? "camera" : "composite", e.value, a.labels, s));
          }
          class xo {
            constructor(e, t) {
              (this._parameters = e), (this._specification = t), C(this, so(this._parameters, this._specification));
            }
            static deserialize(e) {
              return new xo(e._parameters, e._specification);
            }
            static serialize(e) {
          ...
          function wo(e) {
            let t = null;
            if (e instanceof zt) t = wo(e.result);
            else if (e instanceof jt) {
              for (const o of e.args) if (((t = wo(o)), t)) break;
            } else (e instanceof Ye || e instanceof wt) && e.input instanceof xe && "zoom" === e.input.name && (t = e);
            return (
              t instanceof S ||
                e.eachChild((e) => {
                  const o = wo(e);
          ...
          function To(e, t) {
            ...
            return void 0 === o && "resolvedImage" === t.type ? "" : o;
          }
          function zo(e, t, o) {
            const r = Co(e, t),
              i = ["get", e.property];
            if ("categorical" === r && "boolean" == typeof o[0][0]) {
              const r = ["case"];
              for (const e of o) r.push(["==", i, e[0]], e[1]);
              return r.push(To(e, t)), r;
            }
            if ("categorical" === r) {
              const r = ["match", i];
              for (const e of o) Ao(r, e[0], e[1], !1);
              return r.push(To(e, t)), r;
            }
            if ("interval" === r) {
              const t = ["step", ["number", i]];
              for (const e of o) Ao(t, e[0], e[1], !0);
              return _o(t), void 0 === e.default ? t : ["case", ["==", ["typeof", i], "number"], t, ko(e.default)];
            }
            if ("exponential" === r) {
              const t = void 0 !== e.base ? e.base : 1,
                r = [jo(e), 1 === t ? ["linear"] : ["exponential", t], ["number", i]];
              for (const e of o) Ao(r, e[0], e[1], !1);
              return void 0 === e.default ? r : ["case", ["==", ["typeof", i], "number"], r, ko(e.default)];
            }
          ...
          function Eo(e) {
            const t = ["concat"],
              o = /{([^{}]+)}/g;
            let r = 0;
            for (let i = o.exec(e); null !== i; i = o.exec(e)) {
              const n = e.slice(r, o.lastIndex - i[0].length);
          ...
          new Set(["in", "==", "!=", ">", ">=", "<", "<=", "to-boolean"]),
                ...
                var e = function (e, t, o, r) {
                  ...
                  p = {
                    ...
                    parse: function (e) {
                      ...
                      for (var b, v, x, w, k, j, T, z, _ = {}; ; ) {
                        if (
                          ((v = o[o.length - 1]),
                          this.defaultActions[v]
                            ? (x = this.defaultActions[v])
                            : (null == b && (b = g()), (x = n[v] && n[v][b])),
                          void 0 === x || !x.length || !x[0])
                        ) {
                          var A = "";
                          for (k in ((z = []), n[v]))
                            this.terminals_[k] && k > u && z.push("'" + this.terminals_[k] + "'");
                          (A = d.showPosition
                            ? "Parse error on line " +
                              (s + 1) +
                              ":\n" +
                            ...
                            : "Parse error on line " +
                              (s + 1) +
                              ": Unexpected " +
                              (b == c ? "end of input" : "'" + (this.terminals_[b] || b) + "'")),
                            this.parseError(A, {
                              text: d.match,
                        ...
                        switch (x[0]) {
                          ...
                          case 2:
                            if (
                              ...
                              y && (_._$.range = [i[i.length - (j || 1)].range[0], i[i.length - 1].range[1]]),
                              void 0 !== (w = this.performAction.apply(_, [a, l, s, h.yy, x[1], r, i].concat(p))))
                            )
                              return w;
                            j && ((o = o.slice(0, -1 * j * 2)), (r = r.slice(0, -1 * j)), (i = i.slice(0, -1 * j))),
                              o.push(this.productions_[x[1]][0]),
                              r.push(_.$),
                              i.push(_._$),
                              (T = n[o[o.length - 2]][o[o.length - 1]]),
                              o.push(T);
                            break;
                          case 3:
                            return !0;
                    ...
                    var e = {
                      ...
                      next: function () {
                        ...
                        for (var i = this._currentRules(), n = 0; n < i.length; n++)
                          if ((o = this._input.match(this.rules[i[n]])) && (!t || o[0].length > t[0].length)) {
            ...
            new Set(["vector", "raster", "raster-dem"]);
          const So = {
              StyleExpression: fo,
              isExpression: mo,
              isExpressionFilter: function e(t) {
                ...
                switch (t[0]) {
                  ...
                  case "any":
                  case "all":
                    for (const o of t.slice(1)) if (!e(o) && "boolean" != typeof o) return !1;
                    return !0;
                  default:
                    return !0;
                }
              ...
              createExpression: yo,
              createPropertyExpression: vo,
              normalizePropertyExpression: function (e, t) {
                if (no(e)) return new xo(e, t);
                if (mo(e)) {
                  const o = vo(e, t);
                ...
                }
                {
                  let o = e;
                  return (
                    "string" == typeof e && "color" === t.type && (o = Y.parse(e)),
                    { kind: "constant", evaluate: () => o }
                  );
                }
              },
              ZoomConstantExpression: go,
              ZoomDependentExpression: bo,
              StylePropertyFunction: xo,
            },
            Oo = {
              convertFunction: function (e, t) {
                let o = e.stops;
                if (!o)
                  return (function (e, t) {
                    const o = ["get", e.property];
                    if (void 0 === e.default) return "string" === t.type ? ["string", o] : o;
                    if ("enum" === t.type) return ["match", o, Object.keys(t.values), o, e.default];
                    {
                      const r = ["color" === t.type ? "to-color" : t.type, o, ko(e.default)];
                      return "array" === t.type && r.splice(1, 0, t.value, t.length || null), r;
                    }
                  })(e, t);
                const r = o && "object" == typeof o[0][0],
                  i = r || void 0 !== e.property,
                  n = r || !i;
                return (
                  (o = o.map((e) => (!i && t.tokens && "string" == typeof e[1] ? [e[0], Eo(e[1])] : [e[0], ko(e[1])]))),
                  r
                    ? (function (e, t, o) {
                        const r = {},
                          i = {},
                        ...
                        for (let t = 0; t < o.length; t++) {
                          ...
                          void 0 === r[s] &&
                            ...
                            (i[s] = []),
                            n.push(s)),
                            i[s].push([a[0].value, a[1]]);
                        }
                        if ("exponential" === Co({}, t)) {
                          const o = [jo(e), ["linear"], ["zoom"]];
                          for (const e of n) Ao(o, e, zo(r[e], t, i[e]), !1);
                          return o;
                        }
                        {
                          const e = ["step", ["zoom"]];
                          for (const o of n) Ao(e, o, zo(r[o], t, i[o]), !0);
                          return _o(e), e;
                        }
                      })(e, t, o)
                    : n
                      ? (function (e, t, o, r = ["zoom"]) {
                          const i = Co(e, t);
                          let n,
                            a = !1;
                          if ("interval" === i) (n = ["step", r]), (a = !0);
                          else {
                            if ("exponential" !== i) throw new Error(`Unknown zoom function type "${i}"`);
                            {
                              const t = void 0 !== e.base ? e.base : 1;
                              n = [jo(e), 1 === t ? ["linear"] : ["exponential", t], r];
                            }
                          }
                          for (const e of o) Ao(n, e[0], e[1], a);
                          return _o(n), n;
                        })(e, t, o)
                      : zo(e, t, o)
                );
          ...
          function Ro(e) {
            var t = e.expr,
              o = e.layer,
              r = Math.min(t(o, "paint", "circle-radius"), 8),
              i = Math.min(t(o, "paint", "circle-stroke-width"), 4),
              n = t(o, "paint", "circle-color"),
              a = t(o, "paint", "circle-opacity"),
              s = t(o, "paint", "circle-stroke-color"),
              l = t(o, "paint", "circle-stroke-opacity"),
              u = r - i / 2;
            return {
              element: "svg",
              attributes: {
                ...
                style: { filter: "blur(" + t(o, "paint", "circle-blur") * u + "px)" },
              },
              children: [
                {
                  element: "circle",
                  attributes: { key: "l1", cx: 10, cy: 10, fill: n, opacity: a, r: u },
                },
                {
                  element: "circle",
                  attributes: {
            ...
            return {
              ...
              attributes: {
                style: {
                  width: "100%",
                  height: "100%",
                  backgroundImage: "url(" + (0, e.image)(t(o, "paint", "fill-pattern")) + ")",
                  backgroundColor: t(o, "paint", "fill-color"),
                  opacity: t(o, "paint", "fill-opacity"),
          ...
          function qo(e) {
            var t = e.layer,
              o = e.expr,
              r = (0, e.image)(o(t, "paint", "line-pattern")),
              i = {
                stroke: r ? "url(#img1)" : o(t, "paint", "line-color"),
                strokeWidth: Math.max(2, Math.min(o(t, "paint", "line-width"), 8)),
                strokeOpacity: o(t, "paint", "line-opacity"),
                strokeDasharray: o(t, "paint", "line-dasharray"),
              },
              n = i.strokeWidth,
              a = "stroke: " + i.stroke + ";";
            return (
              i.strokeOpacity && (a += "stroke-opacity: " + i.strokeOpacity + ";"),
              i.strokeDasharray && (a += "stroke-dasharray: " + i.strokeDasharray + ";"),
              {
                element: "svg",
                attributes: { viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg" },
                children: [
                  {
                    element: "defs",
                    attributes: { key: "defs" },
                    children: [
                      {
                        ...
                        attributes: {
                          ...
                          patternTransform: "translate(" + -n / 2 + " " + -n / 2 + ") rotate(45)",
                        },
                        children: [
                          {
                            element: "image",
                  ...
                  { element: "path", attributes: { key: "path", style: a, d: "M0 20 L 20 0" } },
                ],
              }
            );
          }
          function No(e) {
            return (
              (function (e) {
                var t = e.image,
                  o = (0, e.expr)(e.layer, "layout", "icon-image");
                if (!o) return null;
                var r = t(o);
                return r
                  ? {
              ...
              ((i = (o = (t = e).expr)((r = t.layer), "paint", "text-color")),
              (n = o(r, "paint", "text-opacity")),
              {
                element: "svg",
                attributes: { viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg" },
                children: [
                  {
                    ...
                    attributes: {
                      ...
                      stroke: o(r, "paint", "text-halo-color"),
                      "stroke-width": 2 * o(r, "paint", "text-halo-width"),
                      fill: "transparent",
                      "stroke-linejoin": "round",
                    },
                  },
                  { element: "path", attributes: { key: "l2", d: a, fill: "white" } },
                  { element: "path", attributes: { key: "l3", d: a, fill: i, opacity: n } },
                ],
              })
            );
            var t, o, r, i, n, a;
          ...
          const Lo = function (e) {
            var t,
              o = e.sprite,
              i = e.layer,
              n = { circle: Ro, symbol: No, line: qo, fill: Io }[i.type],
              a =
                ((t = e.zoom),
                function (e, o, i) {
                  var n,
                    ...
                    s =
                      ((n = i),
                      (a = Do.find(function (e) {
                        return n.startsWith(e[0]);
                      }))
                        ? a[1] || a[0]
                        : null),
                    l = r[o + "_" + s][i];
                  if (!e[o]) return l.default;
                  var u = e[o][i];
                  if (void 0 === u) return l.default;
                  if ("object" == typeof u) {
                    var c;
                    if (Array.isArray(u)) {
                      if ("array" === l.type) return u;
                      c = So.createExpression(u).value;
                    } else c = Oo.createFunction(u, l);
                    if (!c.evaluate) return null;
                    var p = c.evaluate({ zoom: t }, {});
                    ...
                    if (o && o.json) {
                      ...
                      if (t)
                        return (
                          ...
                          (s = i.width),
                          (l = i.height),
                          ((u = document.createElement("canvas")).width = 2 * s),
                          (u.height = 2 * l),
                          u.getContext("2d").drawImage(r, 2 * n, 2 * a, 2 * s, 2 * l, 0, 0, 2 * s, 2 * l),
                          u.toDataURL()
                        );
                    }
                    var r, i, n, a, s, l, u;
        ...
        448: (e, t, o) => {
          ...
          e.exports = function (e) {
            return new Promise(function (t, o) {
              ...
              if (
                (v.open(e.method.toUpperCase(), a(k, e.params, e.paramsSerializer), !0),
                (v.timeout = e.timeout),
                "onloadend" in v
                  ? (v.onloadend = j)
                ...
                (v.onabort = function () {
                  v && (o(new p("Request aborted", p.ECONNABORTED, e, v)), (v = null));
                }),
                (v.onerror = function () {
                  o(new p("Network Error", p.ERR_NETWORK, e, v, v)), (v = null);
                }),
                (v.ontimeout = function () {
                  var t = e.timeout ? "timeout of " + e.timeout + "ms exceeded" : "timeout exceeded",
                    r = e.transitional || c;
                  e.timeoutErrorMessage && (t = e.timeoutErrorMessage),
                    o(new p(t, r.clarifyTimeoutError ? p.ETIMEDOUT : p.ECONNABORTED, e, v)),
                    (v = null);
                }),
                r.isStandardBrowserEnv())
              ) {
                var T = (e.withCredentials || u(k)) && e.xsrfCookieName ? n.read(e.xsrfCookieName) : void 0;
                T && (y[e.xsrfHeaderName] = T);
              }
              "setRequestHeader" in v &&
                r.forEach(y, function (e, t) {
                  void 0 === m && "content-type" === t.toLowerCase() ? delete y[t] : v.setRequestHeader(t, e);
                }),
                ...
                (e.cancelToken || e.signal) &&
                  ((f = function (e) {
                    v && (o(!e || (e && e.type) ? new d() : e), v.abort(), (v = null));
                  }),
                  e.cancelToken && e.cancelToken.subscribe(f),
                  e.signal && (e.signal.aborted ? f() : e.signal.addEventListener("abort", f))),
                m || (m = null);
              var z = h(k);
              z && -1 === ["http", "https", "file"].indexOf(z)
                ? o(new p("Unsupported protocol " + z + ":", p.ERR_BAD_REQUEST, e))
                : v.send(m);
            });
          };
        },
        609: (e, t, o) => {
          ...
          var r = o(867),
            ...
            s = (function e(t) {
              var o = new n(t),
                s = i(n.prototype.request, o);
              return (
                r.extend(s, n.prototype, o),
                r.extend(s, o),
                (s.create = function (o) {
                  return e(a(t, o));
                }),
          ...
          (s.Axios = n),
            (s.CanceledError = o(644)),
            (s.CancelToken = o(972)),
            (s.isCancel = o(502)),
            (s.VERSION = o(288).version),
            (s.toFormData = o(675)),
            (s.AxiosError = o(648)),
        ...
        644: (e, t, o) => {
          ...
          o(867).inherits(i, r, { __CANCEL__: !0 }), (e.exports = i);
        },
        502: (e) => {
          "use strict";
          e.exports = function (e) {
        ...
        321: (e, t, o) => {
          ...
          (p.prototype.request = function (e, t) {
            ...
            if (
              ...
              var p = [a, void 0];
              for (Array.prototype.unshift.apply(p, r), p = p.concat(l), n = Promise.resolve(t); p.length; )
                n = n.then(p.shift(), p.shift());
              return n;
            }
            ...
            for (; l.length; ) n = n.then(l.shift(), l.shift());
            return n;
          }),
            ...
            r.forEach(["delete", "get", "head", "options"], function (e) {
              p.prototype[e] = function (t, o) {
                return this.request(s(o || {}, { method: e, url: t, data: (o || {}).data }));
              };
            }),
        ...
        648: (e, t, o) => {
          ...
          [
            ...
            (i.from = function (e, t, o, a, s, l) {
              var u = Object.create(n);
              return (
                r.toFlatObject(e, u, function (e) {
                  return e !== Error.prototype;
                }),
                i.call(u, e.message, t, o, a, s),
                (u.name = e.name),
                l && Object.assign(u, l),
                u
              );
        ...
        782: (e, t, o) => {
          ...
          (i.prototype.use = function (e, t, o) {
            return (
              this.handlers.push({
                fulfilled: e,
                rejected: t,
        ...
        185: (e, t, o) => {
          ...
          e.exports = function (e, t) {
            ...
            function n(o) {
              return r.isUndefined(t[o]) ? (r.isUndefined(e[o]) ? void 0 : i(void 0, e[o])) : i(e[o], t[o]);
            }
            function a(e) {
              if (!r.isUndefined(t[e])) return i(void 0, t[e]);
            }
            function s(o) {
              return r.isUndefined(t[o]) ? (r.isUndefined(e[o]) ? void 0 : i(void 0, e[o])) : i(void 0, t[o]);
            }
            function l(o) {
              return o in t ? i(e[o], t[o]) : o in e ? i(void 0, e[o]) : void 0;
            }
            var u = {
              url: a,
              method: a,
            ...
            o.status && i && !i(o.status)
              ? t(
                  new r(
                    ...
                    [r.ERR_BAD_REQUEST, r.ERR_BAD_RESPONSE][Math.floor(o.status / 100) - 4],
                    o.config,
                    o.request,
                    o
                  )
              ...
              transformRequest: [
                function (e, t) {
                  ...
                  var o,
                    n = r.isObject(e),
                    a = t && t["Content-Type"];
                  if ((o = r.isFileList(e)) || (n && "multipart/form-data" === a)) {
          ...
          e.exports = r.isStandardBrowserEnv()
            ? (function () {
                ...
                function i(e) {
                  var r = e;
                  return (
                    t && (o.setAttribute("href", r), (r = o.href)),
        ...
        109: (e, t, o) => {
          ...
          e.exports = function (e) {
            ...
            return e
              ? (r.forEach(e.split("\n"), function (e) {
                  if (
                    ((n = e.indexOf(":")), (t = r.trim(e.substr(0, n)).toLowerCase()), (o = r.trim(e.substr(n + 1))), t)
                  ) {
            ...
            return (
              (function e(n, a) {
                if (r.isPlainObject(n) || r.isArray(n)) {
                  if (-1 !== o.indexOf(n)) throw Error("Circular reference detected in " + a);
                  o.push(n),
                    r.forEach(n, function (o, n) {
                      if (!r.isUndefined(o)) {
                        var s,
                          l = a ? a + "." + n : n;
                        if (o && !a && "object" == typeof o)
                          if (r.endsWith(n, "{}")) o = JSON.stringify(o);
                          else if (r.endsWith(n, "[]") && (s = r.toArray(o)))
        ...
        875: (e, t, o) => {
          ...
          var a = {};
          (n.transitional = function (e, t, o) {
            function n(e, t) {
              return "[Axios v" + r + "] Transitional option '" + e + "'" + t + (o ? ". " + o : "");
            }
            return function (o, r, s) {
              if (!1 === e) throw new i(n(r, " has been removed" + (t ? " in " + t : "")), i.ERR_DEPRECATED);
              return (
                t &&
                  !a[r] &&
                  ((a[r] = !0),
            ...
            (e.exports = {
              assertOptions: function (e, t, o) {
                ...
                for (var r = Object.keys(e), n = r.length; n-- > 0; ) {
                  ...
                  } else if (!0 !== o) throw new i("Unknown option " + a, i.ERR_BAD_OPTION);
                }
              },
              validators: n,
            });
        ...
        867: (e, t, o) => {
          ...
          e.exports = {
            ...
            merge: function e() {
              ...
              for (var r = 0, i = arguments.length; r < i; r++) v(arguments[r], o);
              return t;
            },
            extend: function (e, t, o) {
              return (
                v(t, function (t, r) {
                  e[r] = o && "function" == typeof t ? i(t, o) : t;
                }),
                e
              );
            },
        ...
        620: function (e, t, o) {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }), (t.MapboxLegendControl = void 0);
          var i = o(770);
          Object.defineProperty(t, "MapboxLegendControl", {
            enumerable: !0,
            get: function () {
              return r(i).default;
            },
          ...
          t.default = class {
            constructor(e, t) {
              (this.uncheckedLayers = {}),
                ...
                (this.sprite = { image: HTMLImageElement, json: JSON }),
                (this.targets = e),
            ...
            changeLayerVisibility(e, t) {
              ...
              if (m.getLayer(e)) {
                var o, r;
                t
                  ? (this.uncheckedLayers[e] && delete this.uncheckedLayers[e],
                    null === (o = this.map) || void 0 === o || o.setLayoutProperty(e, "visibility", "visible"))
                  : ((this.uncheckedLayers[e] = e),
                    null === (r = this.map) || void 0 === r || r.setLayoutProperty(e, "visibility", "none"));
                const i = document.getElementsByName(e);
                for (let e in i) "number" != typeof i[e] && (i[e].checked = t);
              }
            }
            createLayerCheckbox(e) {
              ...
              r.className = "legend-table-td";
              const i = document.createElement("input");
              i.setAttribute("type", "checkbox"), i.setAttribute("name", e.id), i.setAttribute("value", e.id);
              const n = null === (t = this.map) || void 0 === t ? void 0 : t.getLayoutProperty(e.id, "visibility");
              if (n) {
                let t = !0;
                switch (n) {
                  case "none":
                ...
                o.changeLayerVisibility(e.id, t);
              } else i.checked = !0;
              return (
                i.addEventListener("click", function (e) {
                  var t, r;
                  const i = null === (t = e.target) || void 0 === t ? void 0 : t.value,
                    n = null === (r = e.target) || void 0 === r ? void 0 : r.checked;
                  const u = `${i}-outline`;
                  o.changeLayerVisibility(u, n);
                  o.changeLayerVisibility(i, n);
                }),
                r.appendChild(i),
                r
              );
            ...
            getLayerLegend(e) {
              const t = this.map,
                o = null == t ? void 0 : t.getZoom(),
                r = this.sprite;
              let i = (0, a.default)({ sprite: r, zoom: o, layer: e });
              var n = document.createElement("TR");
              const s = this.createLayerCheckbox(e);
              s && n.appendChild(s);
              var l = document.createElement("TD");
              if (((l.className = "legend-table-td"), i))
                switch (i.element) {
                  case "div":
                    if (
                      i.attributes.style.backgroundImage &&
                      !["url(undefined)", "url(null)"].includes(i.attributes.style.backgroundImage)
                    ) {
                      var u = document.createElement("img");
                      (u.src = i.attributes.style.backgroundImage.replace("url(", "").replace(")", "")),
                        (u.alt = e.id),
                        (u.style.cssText = "height: 17px;"),
                        l.appendChild(u);
                    }
                    (l.style.backgroundColor = i.attributes.style.backgroundColor),
                      (l.style.backgroundPosition = i.attributes.style.backgroundPosition),
                      (l.style.backgroundSize = i.attributes.style.backgroundSize),
                      (l.style.backgroundRepeat = i.attributes.style.backgroundRepeat),
                      (l.style.opacity = i.attributes.style.opacity);
                    break;
                  case "svg":
                    let t = document.createElementNS("http://www.w3.org/2000/svg", "svg");
                    (t.style.cssText = "height: 17px;"),
                      t.setAttributeNS(null, "version", "1.1"),
                      Object.keys(i.attributes).forEach((e) => {
                        t.setAttribute(e, i.attributes[e]);
                        let o = document.createElementNS("http://www.w3.org/2000/svg", "g");
                        i.children.forEach((e) => {
                          var t = document.createElementNS("http://www.w3.org/2000/svg", e.element);
                          Object.keys(e.attributes).forEach((o) => {
                            t.setAttributeNS(null, o, e.attributes[o]);
                          }),
                            o.appendChild(t);
                        }),
                          t.appendChild(o);
                      ...
                      (document.createElement("label").textContent =
                        this.targets && this.targets[e.id] ? this.targets[e.id] : e.id),
                      l.appendChild(t);
                    break;
                  default:
                    return void console.log(i.element);
                }
              else {
                ...
                t.setAttribute("fill", "none"),
                  ...
                  r.setAttribute("d", "M18,9a3,3,0,1,0-3-3A3,3,0,0,0,18,9Zm0-4a1,1,0,1,1-1,1A1,1,0,0,1,18,5Z"),
              ...
              c.className = "legend-table-td";
              let p = document.createElement("label");
              return (
                (p.textContent = this.targets && this.targets[e.id] ? this.targets[e.id] : e.id),
                c.appendChild(p),
                n.appendChild(l),
                n.appendChild(c),
                n
            ...
            updateLegendControl() {
              const e = this.map,
                t = {};
              if (e) {
                const o = e.queryRenderedFeatures();
                for (let e of o) t[e.layer.id] = e.layer;
              }
              let o = null == e ? void 0 : e.getStyle().layers;
              if (o) {
                for (
                  this.legendTable ||
                  ...
                  this.legendTable.firstChild;

                )
                  this.legendTable.removeChild(this.legendTable.firstChild);
                this.options.reverseOrder && (o = o.reverse()),
                  o.forEach((e) => {
                    if (
                      (t[e.id] && this.uncheckedLayers[e.id]
                        ? delete this.uncheckedLayers[e.id]
                        : this.uncheckedLayers[e.id] && (t[e.id] = e),
                      void 0 === this.targets ||
                        (this.targets && 0 === Object.keys(this.targets).length) ||
                        (this.targets &&
                          Object.keys(this.targets)
                            .map((e) => e)
                            .includes(e.id)))
                    ) {
                      if (this.onlyRendered && !t[e.id]) return;
                      const o = this.getLayerLegend(e);
                      if (!o) return;
            ...
            onAdd(e) {
              ...
              t.classList.add("mapboxgl-legend-title-label"),
                (t.textContent = this.options.title || "Legend"),
                this.legendContainer.appendChild(t),
                this.legendContainer.appendChild(document.createElement("br"));
              const o = document.createElement("input");
              o.setAttribute("type", "checkbox");
              const i = "mapboxgl-legend-onlyrendered-checkbox-" + 100 * Math.random();
              o.setAttribute("id", i),
                o.classList.add("mapboxgl-legend-onlyRendered-checkbox"),
                (o.checked = this.onlyRendered);
              const a = this;
              o.addEventListener("click", function (e) {
                var t;
                const o = null === (t = e.target) || void 0 === t ? void 0 : t.checked;
                (a.onlyRendered = !!o), a.updateLegendControl();
              }),
                this.legendContainer.appendChild(o);
              const s = document.createElement("label");
              s.classList.add("mapboxgl-legend-onlyRendered-label"),
                (s.textContent = "Only rendered"),
                (s.htmlFor = i),
                this.legendContainer.appendChild(s),
                this.legendContainer.appendChild(document.createElement("br")),
              ...
              const l = () =>
                r(this, void 0, void 0, function* () {
                  if (e.loaded()) {
                    let t = e.getStyle().sprite,
                      o = "";
                    t &&
                      t.includes("mapbox://") &&
                      ((t = t.replace(/mapbox:\/\//g, n.baseApiUrl).replace(/sprites/g, "/styles/v1")),
                      (t = `${t}/sprite`),
                      (o = `?access_token=${this.options.accesstoken || n.accessToken}`));
                    const r = Promise.all([this.loadImage(`${t}@2x.png${o}`), this.loadJson(`${t}.json${o}`)]);
                    yield r.then(([e, t]) => {
                      this.setSprite(e, t);
                    }),
                      this.updateLegendControl(),
              ...
              return (
                this.map.on("idle", l),
                this.options &&
                  1 == this.options.showDefault &&
                  ((this.legendContainer.style.display = "block"), (this.legendButton.style.display = "none")),
            ...
            onDocumentClick(e) {
              this.controlContainer &&
                !this.controlContainer.contains(e.target) &&
                this.legendContainer &&
                this.legendButton &&
                this.options &&
                !0 !== this.options.showDefault &&
                ((this.legendContainer.style.display = "none"), (this.legendButton.style.display = "block"));
            }
            setSprite(e, t) {
              this.sprite = { image: e, json: t };
            }
            loadImage(e) {
              let t = !1;
            ...
            loadJson(e) {
              return s.default.get(e, { responseType: "json" }).then((e) => e.data);
            }
          };
        },
        640: (t) => {
